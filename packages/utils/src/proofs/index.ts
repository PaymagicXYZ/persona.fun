...
import createPostCircuit from "@persona/circuits/create-post/target/main.json" assert { type: 'json' };
import submitHashCircuit from "@persona/circuits/submit-hash/target/main.json" assert { type: 'json' };
